...
CREATE TABLE crop_listings (
  ...
  images JSON NULL,
  status ENUM('pending','approved','rejected','active','sold','sold_out','inactive','expired') NOT NULL DEFAULT 'pending',
...
CREATE TABLE transactions (
  ...
  status ENUM('pending','sent','received','verified','failed','cancelled','completed','refunded') NOT NULL DEFAULT 'pending',
  description TEXT NULL,
