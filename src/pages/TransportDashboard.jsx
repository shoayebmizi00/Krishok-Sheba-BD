...
export default function TransportDashboard() {
  ...
  const pageTitle = SIDEBAR_LINKS.find((link) => link.path === location.pathname || (link.path !== '/transport-dashboard' && location.pathname.startsWith(`${link.path}/`)))?.label || t('overview');
